...
class FDEazrAndroidFaceDetectorPainter extends CustomPainter {
  ...
  FDEazrAndroidFaceDetectorPainter({
    required this.model,
  ...
  @override
  bool shouldRepaint(FDEazrAndroidFaceDetectorPainter oldDelegate) {
