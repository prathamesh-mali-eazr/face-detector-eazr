...
import 'package:face_detector_eazr/src/core/theme/color_scheme.dart';
import 'package:face_detector_eazr/src/core/theme/gauges_theme.dart';
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (needsShowPointer) {
      ...
      if (markerPointerRenderer != null) {
        markerPointerRenderer!.drawPointer(canvas, pointerPaintingDetails,
            _gaugeThemeData as SfGaugeThemeData);
      } else {
